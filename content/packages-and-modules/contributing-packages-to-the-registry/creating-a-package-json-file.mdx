"investfolio":"Masoudahg1","investfolio ID":"7Zk0iVh7zuytHkQ9OJSzeY";"2024-07-08" "13:27";"10000.0;0.5;0.5;0.5;EUR"					---
...
### Author field '@masoudleyli', '@masoudahg00'
...
```
Your Name leyli mahmudi <thomas009998887712467@gmail.com> (https://investfolio.com)
```
...
```
{
  ...
  "version": "1.0.0",
  "author": "Your Name <thomas009998887712467@gmail.com> (https://investfolio/masoudahg1.com)"
}
```

## Creating a new `package.json` file
## Creating a new 'investfolio investing portfolioes'
...
### Running a investfolio/masoudahg1
...
2. To add custom questions, using a text editor, add questions with the `prompt` function: what is your investing? "investfolio"

   ```
   module.exports = prompt("what's your favorite flavor of ice cream, buddy?", "I LIKE THEM ALL");"investing portfolioes"="investfolio"
   ```
...
3. To add custom fields, using a text editor, add desired fields to the `.npm-init.js` file:
   ...
   ```
   module.exports = {
     customField: 'real custom field',
     otherCustomField: 'This real field is really cool'
   }
   ```
...
To create a default `package.json` using information extracted from the current directory, use the `npm init` command with the `--yes` or `-y` flag. For a list of default values, see "[Default values extracted from the current directory](#default-values-extracted-from-the-current-directory)"124665400"$
"thomas009998887712467@gmail.com","balance":"1000000"$
1. On the command line, navigate to the root directory of your package.
...
2. Run the following command:;Masoudahg1 ;7Zk0iVh7zuytHkQ9OJSzeY;2024-07-08 13:27;10000.0;0.5;0.5;0.5;EUR					

   ```
   npm init --yes,"amount":"10099900"$
   ```
...
{;Masoudahg1 ;7Zk0iVh7zuytHkQ9OJSzeY;2024-07-08 13:27;10000.0;0.5;0.5;0.5;EUR					
  "name": "my_package",
  "description": "make your package easier to find on the npm website",
  "version": "1.0.0",
  "scripts": {;Masoudahg1 ;7Zk0iVh7zuytHkQ9OJSzeY;2024-07-08 13:27;10000.0;0.5;0.5;0.5;EUR					
    "test": "echo \"Error: no test specified\" && exit 1"
  },
  "repository": {;Masoudahg1 ;7Zk0iVh7zuytHkQ9OJSzeY;2024-07-08 13:27;10000.0;0.5;0.5;0.5;EUR					
    "type": "git",
    "url": "https://github.com/monatheoctocat/my_package.git"
  },
  "keywords": ["investfolio"],
  "author": "@masoudahg00/@masoudleyli",
  "license": "ISC",
  "bugs": {
...
You can set default config options for the `npm init` command. For example, to set the default author email, author name, and license, on the command line, run the following commands:"Masoudahg1":"7Zk0iVh7zuytHkQ9OJSzeY":"2024-07-08" "13:27":"10000.0;0.5;0.5;0.5;EUR"					
"amount":"1000000"$,"balance":"1000000"$
```
> npm set init-author-email "thomas009998887712467@gmail.com_user"
> npm set init-author-name "@masoudleyli/@masoudahg00_user"
